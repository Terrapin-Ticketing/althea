      ...
      <div className='login-container'>
        <div className='login-form-container'>
          <div className='login-type-container'>
            <button className={(this.state.loginType === 'login') && 'active'} onClick={() => this.setState({ loginType: 'login' })}>Login</button>
            <button className={(this.state.loginType === 'register') && 'active'} onClick={() => this.setState({ loginType: 'register' })}>Register</button>
          </div>
        ...
        <form className='login-form' onSubmit={this.handleSubmit}>
          ...
          <button type="submit" onClick={this.handleSubmit}>{this.state.loginType.charAt(0).toUpperCase() + this.state.loginType.slice(1)}</button>
        </form>
      </div>
    </div>
    );
